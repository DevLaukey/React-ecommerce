    ...
    <div className="landing">
      ...
      <div class="content">
        <div class="images" onClick={handleOpenPicModal}>
          ...
          <div className="">
            <Modal
              aria-labelledby="transition-picModal-title"
              aria-describedby="transition-picModal-description"
              open={picOpen}
            ...
            >
              <Fade in={picOpen}>
                <Box sx={style}>
                  <Typography
                    id="transition-picModal-title"
                    variant="h5"
                    sx={{ mb: 2 }}
                    component="h1"
                  >
                    <Button onClick={handleClosePicModal}>
                      <svg
                        width="14"
                        height="15"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Box>
                    <Typography id="transition-picModal-description">
                      Cdcd
                    </Typography>
                  </Box>
                </Box>
