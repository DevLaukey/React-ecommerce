...
function Content() {
  ...
  const changeImages = (id) => {
    switch (id) {
      case 1:
         setUrl("https://raw.githubusercontent.com/DevLaukey/ecommerce-design/main/assets/image-product-1.jpg");
        break;
      case 2:
       
          setUrl("https://raw.githubusercontent.com/DevLaukey/ecommerce-design/main/assets/image-product-2.jpg");
        break;
      case 3:
       
          setUrl("https://raw.githubusercontent.com/DevLaukey/ecommerce-design/main/assets/image-product-3.jpg");
        break;
      default:
